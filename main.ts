...
function level5 () {
    game.showLongText("Don't run into still mutated ducks", DialogLayout.Full)
    lvl5 = true
    tiles.setCurrentTilemap(tilemap`level1`)
    Cure1 = false
    cure2 = false
    ...
    for (let index = 0; index < 15; index++) {
        Normal = sprites.create(img`
            ...
            . . . . . . . . . . . . . . . . 
            `, SpriteKind.Friend)
        tiles.placeOnRandomTile(Normal, assets.tile`myTile3`)
    }
    one = sprites.create(img`
        ....................
        ....................
    ...
    Three = sprites.create(img`
        ...
        ....................
        `, SpriteKind.Part3)
    tiles.placeOnRandomTile(Three, assets.tile`myTile3`)
    duck4 = sprites.create(img`
        . . . . . . . . . . . . . . . . 
        . . . . . . . . . . 8 7 b . . . 
        . . . . . . . . . 8 7 8 . . . . 
